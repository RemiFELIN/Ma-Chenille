...
public class FelinDiazCercle {
	...
	public static final int yMax=500; // ordonnée maximum de la fenêtre
        // l'origine (i.e. (0,0)) représente le coin supérieur gauche de la fenêtre 
      	...
      	* @param d diamètre
      	*/
      	public FelinDiazCercle(float x, float y, float d){
		this.abscisse=x; 
		this.ordonnee=y; 
		this.diametre=d;
	}
      	...
      	* @param d diamètre
      	*/
     	public FelinDiazCercle(float d){
		this(xMax/2, yMax/2, d);
	}
      	...
      	*/
      	public FelinDiazCercle(){ 
		this(xMax/2, yMax/2, 5); 
	}
		...
		this.ordonnee=y;
      	...
      	*/
      	public final void setDiametre(float d){
		this.diametre=d;
	}
      	...
      	* @param y ordonnee
      	*/
      	public void deplacerVers(float x, float y){
		this.setAbscisse(x);
		this.setOrdonnee(y);
	}
