...
public class FelinDiazCercleAnime extends FelinDiazCercle {
    ...
    */
    public FelinDiazCercleAnime(float x, float y, float d, float cap){
        super(x, y, d); 
        this.cap = cap;
    }
    ...
    * @param cap du CercleAnimé
    */
    public FelinDiazCercleAnime(float d, float cap){
        super(d); 
        this.cap = cap;
    }
    ...
    */
    ...
    public FelinDiazCercleAnime(float cap){ 
        super(xMax/2, yMax/2, 0); 
        this.cap = cap;
    }
    ...
    */
    ...
    public FelinDiazCercleAnime(){ 
        super(xMax/2, yMax/2, 5); 
        this.cap = 0;
    }
    ...
    */
    ...
    public void tourner(float deltaCap){ 
