...
public class FelinDiazTeteDeChenille extends FelinDiazCercleAnime {
	...
	private float angleDeVision; // angle de vision exprimé en degré
       	...
       	*/
       	public FelinDiazTeteDeChenille(){
		super(); 
		angleDeVision = 45;
	}
       	...
       	* Constructor for objects of class TeteDeChenille
       	*/
       	public FelinDiazTeteDeChenille(float vision){
		super(); 
		angleDeVision = vision; 
	}
	   
       	/*************************************************  
       	* Constructor for objects of class TeteDeChenille
       	*/
       	public FelinDiazTeteDeChenille(float d, float cap, float vision){
		super(d,cap); 
		angleDeVision = vision;
	}
       	...
       	* Constructor for objects of class TeteDeChenille
       	*/
       	public FelinDiazTeteDeChenille(float x, float y, float d, float cap, float vision){
		super(x, y, d, cap); 
		angleDeVision = vision;
	}

       	public float getAngleDeVision(){
		return this.angleDeVision;
	}
	
       	public void setAngleDeVision(float a){
		this.angleDeVision = a % 360;
	}
